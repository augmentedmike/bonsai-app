/**
 * Bonsai icon library.
 * All icons accept className and style props.
 * Add new icons here — never draw SVGs inline in components.
 */
...
export function IconEyeSlash({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function IconCrosshair({ className, style }: IconProps) {
  return (
...
export function IconHand({ className, style }: IconProps) {
  return (
